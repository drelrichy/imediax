...
//  const action = params.action;
 ...
 console.log("in the component ",{params});
      ...
      {  //  <!-- Login button -->
        ...
        {  //  <!-- Register link -->
          ...
          <p className="mb-0 mt-2 pt-1 text-sm font-semibold">
            ...
            <Link  className="text-green transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"
             href={"/login"}>Login</Link>  <Link  className="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-green-700"
             href={"/forgot"}>
